(function () {
    ...
    */
    ...
    assessmentButton.onclick = () => {
        ...
        if (userName.length === 0) { //名前が空欄のときは処理を終了
            return;
        }
    ...
    */
    ...
    //test code
    console.assert(
        assessment('shunsuke') === 'shunsukeのいいところは決断力です。太郎がする決断にいつも助けられる人がいます。',
        '診断結果の文言の特定の部分を名前に置き換える処理が正しくありません。'
    );

    console.assert(
        assessment('shunsuke') === assessment('shunsuke'),
